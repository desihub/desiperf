...
'Observation': ['EXPID','DATE_OBS','TARGTRA','TARGTDEC','SKYRA','SKYDEC','DELTARA','DELTADEC',
        'REQTIME','EXPTIME','FOCUS_X','FOCUS_Y','FOCUS_Z','FOCUS_TIP','FOCUS_TILT','FOCUS_ROT','AIRMASS',
...
'Telescope': ['AIR_FLOW','AIR_TEMP','TRUSS_TEMP','AIR_IN_TEMP','FLOWRATE_IN',
...
'Observation': ['EXPID','TARGTRA','TARGTDEC','SKYRA','SKYDEC','DELTARA','DELTADEC',
        'REQTIME','EXPTIME','FOCUS_X','FOCUS_Y','FOCUS_Z','FOCUS_TIP','FOCUS_TILT','FOCUS_ROT',
